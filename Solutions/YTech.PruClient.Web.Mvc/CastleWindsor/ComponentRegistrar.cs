...
namespace YTech.PruClient.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("YTech.PruClient.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("YTech.PruClient.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("YTech.PruClient.Infrastructure")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("YTech.PruClient.Domain"));
        }
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("YTech.PruClient.Web.Mvc")
                    .Pick()
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("YTech.PruClient.Tasks")
                    .Pick()
                    .WithService.FirstInterface());
        }
    }
